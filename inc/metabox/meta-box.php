            ...
            <div class="inside hidden">
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of team members to be shown', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="display_members"><?php esc_html_e( 'Display Members', 'team-free' ) ?></label>
                    </div>
		            <?php
		            $default_value    = '4';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of display team members', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="items_small_desktop"><?php esc_html_e( 'Display Members on Small Desktop', 'team-free' ) ?></label>
                    </div>
					<?php
					$default_value  = '3';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of display team members on small desktop', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="items_tablet"><?php esc_html_e( 'Display Members on Tablet', 'team-free' ) ?></label>
                    </div>
					<?php
					$default_value  = '2';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of display team members on Tabled', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="items_mobile"><?php esc_html_e( 'Display Members on Mobile', 'team-free' ) ?></label>
                    </div>
					<?php
					$default_value  = '1';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of display team members on Mobile', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta sp-only-for-pro">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <br>
                        <ul>
                            <li><input disabled type="radio" name="rtl" value="true" checked><?php esc_html_e('Yes', 'team-free') ?></li>
                            <li><input disabled type="radio" name="rtl" value="false"><?php esc_html_e('No', 'team-free') ?></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="inside hidden">
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Number of display products', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Pagination option on/off', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Navigation option on/off', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="stop_on_hover"><?php esc_html_e( 'Stop on hover', 'team-free' ) ?></label>
                    </div>
					<?php
					$default_value = 'true';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Carousel stop on hover', 'team-free') ?></p>
                    </div>
                </div>
            ...
            <div class="inside hidden">
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Set pagination background color', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Set navigation color', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Set navigation background color', 'team-free') ?></p>
                    </div>
                </div>
                ...
                <div class="sp-single-meta">
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Set navigation hover color', 'team-free') ?></p>
                    </div>
                </div>

                <div class="sp-single-meta">
                    <div class="sp-meta-th">
                        <label for="navigation_hover_border_color"><?php esc_html_e( 'Navigation Hover Border Color', 'team-free' ) ?></label>
                    </div>
					<?php
					$default_value = '#459fb5';
                    ...
                    <div class="sp-meta-td">
                        ...
                        <p class="sp-meta-des"><?php esc_html_e('Set navigation hover border color', 'team-free') ?></p>
                    </div>
                </div>
